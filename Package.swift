...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.10.5/lefthook.artifactbundle.zip",
            checksum: "917b13e4a1d9dad88d15736cfa37da118a06dbc297da9bbd680f02fd0cd7d4af"
        ),
    ],
