...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.6.15/lefthook.artifactbundle.zip",
            checksum: "d2e374350cf7db2c4aab672e4c1fe0e391a59e585d4e01e0822ba16053428fe9"
        ),
    ],
