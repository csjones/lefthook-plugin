...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.8.2/lefthook.artifactbundle.zip",
            checksum: "84ad87d83e8d8329bb7edce41ab5fb565badc3580df737f0364a279e8635ed97"
        ),
    ],
