...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.16/lefthook.artifactbundle.zip",
            checksum: "359e382c37286430f1231482444878489413c1345a0f59e11ddba1a95c60523c"
        ),
    ],
