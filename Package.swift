...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.10.9/lefthook.artifactbundle.zip",
            checksum: "ea30f35bd6ac7f2482ac100c5f5cf9f7d09ae31cec2ede8e1f74c75da6d5beee"
        ),
    ],
