...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.0/lefthook.artifactbundle.zip",
            checksum: "ff25bf6b35a7f1094bbb6b7ffc77bb53e01d972278ab1660400e2af4d11a6eb5"
        ),
    ],
