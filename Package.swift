...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.21/lefthook.artifactbundle.zip",
            checksum: "ec4b4a15d27eba5dc8e3b14352f3263be6768ef820b1fc49e08e7d60f911739c"
        ),
    ],
