...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.12.3/lefthook.artifactbundle.zip",
            checksum: "af5f54da0d2649100b30103f8f5c448f46f3533a91401caa8ddf6a61154c7838"
        ),
    ],
