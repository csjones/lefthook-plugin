...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/2.0.8/lefthook.artifactbundle.zip",
            checksum: "3043c71be768376386426ad4186cfb55cd6aa7316346ae49c91e084198f8f767"
        ),
    ],
