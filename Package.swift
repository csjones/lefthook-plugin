...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.5/lefthook.artifactbundle.zip",
            checksum: "7fdc0ef70528968b07dcf8ddc315bd9836c8cda8e4869ac3680c32ff2e169fd1"
        ),
    ],
