...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.6.21/lefthook.artifactbundle.zip",
            checksum: "2c5ffc3f9efe8631cd3cd073896f6c751dd9c93cdd58804e9ee660327b290215"
        ),
    ],
