...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.12.4/lefthook.artifactbundle.zip",
            checksum: "c3696e067cd4f41525e8f2358927561e90215f3e6422295b608b2685132489be"
        ),
    ],
