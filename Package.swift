...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/2.1.6/lefthook.artifactbundle.zip",
            checksum: "e63013bf7a0857242f5a5215904700f280b89a087d348543014524268f52285c"
        ),
    ],
