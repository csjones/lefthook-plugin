...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.10/lefthook.artifactbundle.zip",
            checksum: "8b38e0bad6e1c424300bf038eaa076808ce1772d7ae6f1c966a67ce0fea8f546"
        ),
    ],
