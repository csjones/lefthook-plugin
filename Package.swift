...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.16/lefthook.artifactbundle.zip",
            checksum: "7b6ea0875b2a462c40b626622da1368f51a71ad4cd7ad048ef575f2e7aa34b85"
        ),
    ],
