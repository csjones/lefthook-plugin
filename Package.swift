...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.11/lefthook.artifactbundle.zip",
            checksum: "6049b35263a566a872c737e5008b9a858ed227c01492f1978b42290ad28ea753"
        ),
    ],
