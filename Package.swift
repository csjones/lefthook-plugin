...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.4/lefthook.artifactbundle.zip",
            checksum: "e3a51b3e736ce77b48ee4eedca9a3dd0b5febb2afa6144ca0c833ccce5a94b6b"
        ),
    ],
