...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.3/lefthook.artifactbundle.zip",
            checksum: "bab92fade997cf3268da06fbda0b08e988efb828e0789686cea1f280e0206cae"
        ),
    ],
