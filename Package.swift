...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.6/lefthook.artifactbundle.zip",
            checksum: "fb7f2a46099eaa7f8b0fd0297fd1528fa36a6cce37e6e7ef90c073950235b84c"
        ),
    ],
