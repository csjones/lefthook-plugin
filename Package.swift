...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.2/lefthook.artifactbundle.zip",
            checksum: "be970f7b0a52ce377e193a83fae823387bf72f2c69ac84a9a87535cb8ffd8409"
        ),
    ],
