...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/2.0.0/lefthook.artifactbundle.zip",
            checksum: "2ff28ad8028b12414018bb09bd3e3c95886bf9c6573fd6fc60b56fb5f6357268"
        ),
    ],
