...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.13.0/lefthook.artifactbundle.zip",
            checksum: "9d64b4fe3602d043f399315921e7391a39ab8326381383719cb2628046b29293"
        ),
    ],
