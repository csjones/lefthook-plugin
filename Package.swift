...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.12/lefthook.artifactbundle.zip",
            checksum: "a481451211ca0e8163e1457226879f785ecabdf515f5d407ff7658cefc4572d9"
        ),
    ],
