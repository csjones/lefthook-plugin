...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.9.1/lefthook.artifactbundle.zip",
            checksum: "1f5c376c18bb84dbb74e546b9a55173f1727c9684b8b61ebdfe973835567f2da"
        ),
    ],
