...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.10.7/lefthook.artifactbundle.zip",
            checksum: "7e82947c156865290039c42b178f7d1e932eb0af04292a758eba7b0d1db9cf45"
        ),
    ],
