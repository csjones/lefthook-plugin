...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.1/lefthook.artifactbundle.zip",
            checksum: "29356542ad5e0ce344b073ed4385fdd2c6407740b2ed9e85db9f5f92ea69131a"
        ),
    ],
