...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.12.0/lefthook.artifactbundle.zip",
            checksum: "e793b99f9941bf9ff34621b4bc1c9e58a3b95257e243e4d98903cecc0cf3be95"
        ),
    ],
