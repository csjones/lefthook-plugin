...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.15/lefthook.artifactbundle.zip",
            checksum: "6c347b0a8bf361da7ce1fcc5528f664504625cd35db59e7610c31297ca19cdaa"
        ),
    ],
