...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.13.4/lefthook.artifactbundle.zip",
            checksum: "bcc48d93aace45989cdfaef22e84471d6f899fe2d5796bb0d4c9a635fbc5af23"
        ),
    ],
