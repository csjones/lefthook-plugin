...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.8/lefthook.artifactbundle.zip",
            checksum: "8c6aaa3826a960e18db0eac5cc96be9f5c7de7ba92e4ce9452b39aaafed742ba"
        ),
    ],
