...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/2.0.6/lefthook.artifactbundle.zip",
            checksum: "aed7c02679141713aaf6375440aa2543c531bb24783ef18c5c1e59f0e96972aa"
        ),
    ],
