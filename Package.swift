...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.10.8/lefthook.artifactbundle.zip",
            checksum: "c98b78a055b679b67d48aa3a5a5b3d81914d63e95d4648e842e30b0b0b9148c9"
        ),
    ],
