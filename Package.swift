...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.8.4/lefthook.artifactbundle.zip",
            checksum: "24ca2bc184a6ae6d816babfab7c797ee1394017d694cfd9e99c5c45dc9b7e11d"
        ),
    ],
