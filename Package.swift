...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.8.1/lefthook.artifactbundle.zip",
            checksum: "2b91f6e2714f487c30c0b42d80afa738cee43db08ca5efbc243ad7293e83b54b"
        ),
    ],
