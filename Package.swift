...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.7.18/lefthook.artifactbundle.zip",
            checksum: "459689cdde45adbbf1a54f4bd7b4150311caa7e8f53172cb8dace447f294eba9"
        ),
    ],
