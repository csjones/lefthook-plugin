...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.12.2/lefthook.artifactbundle.zip",
            checksum: "9fdde67c3dfdaeff1faf2a3d91287052198508cfca63cf9c491d785b71789c77"
        ),
    ],
