...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.13.3/lefthook.artifactbundle.zip",
            checksum: "58c5b614dcb85b69dec39c9f149030f972a88e23fae8300726d8f89b05bd2c17"
        ),
    ],
