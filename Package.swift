...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.10.0/lefthook.artifactbundle.zip",
            checksum: "98d07e4cc592757237bcb14468a96f81915ce69ac33119915ab83e5438070ad4"
        ),
    ],
