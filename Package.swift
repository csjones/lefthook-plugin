...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.9.3/lefthook.artifactbundle.zip",
            checksum: "a686e32c9a3666e908528b2f49cad90d2439b4d48f3bbb043e8fb38c573dec49"
        ),
    ],
