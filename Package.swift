...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.11.13/lefthook.artifactbundle.zip",
            checksum: "6996a59eb4de4c1d388c6d23c0707d3a7ef9789e114839f55c31f2b8d373a488"
        ),
    ],
