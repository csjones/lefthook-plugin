...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.8.3/lefthook.artifactbundle.zip",
            checksum: "2f0c3ec62a25ea6aef39dfe902d93682e4c5ffb00f4b09e9d1af5ab914824b87"
        ),
    ],
