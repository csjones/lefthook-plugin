...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.13.1/lefthook.artifactbundle.zip",
            checksum: "4697b0b38659ebad89ff8083780e2683900905ff6b73cb272ed50ffaccda7b1e"
        ),
    ],
