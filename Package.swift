...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/2.0.2/lefthook.artifactbundle.zip",
            checksum: "84ff6b0e1d84f257f14e176b7b38c2db708ed01426086ff3385e58a50aa6376d"
        ),
    ],
