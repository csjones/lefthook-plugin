...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "lefthook",
            url: "https://github.com/csjones/lefthook-plugin/releases/download/1.9.0/lefthook.artifactbundle.zip",
            checksum: "7e1caac622d792570166739c7c6fce9f55bd749424ff14d2c46dca2888be8a9a"
        ),
    ],
